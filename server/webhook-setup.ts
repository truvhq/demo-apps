...
async function registerWebhook(truvClient: TruvClient, webhookUrl: string): Promise<void> {
...
export async function setupWebhook({ path, truvClient }: { path: string; truvClient: TruvClient }): Promise<string | null> {
...
export async function teardownWebhook(truvClient: TruvClient): Promise<void> {
  if (webhookId) {
    try {
