        ...
        <div class="intro-slide">
          <div class="relative z-10 w-full max-w-2xl mx-auto px-4">
            <div class="animate-slideUp">
              <div class="text-[12px] font-medium uppercase tracking-[0.08em] text-primary mb-4">Mortgage · Document Processing</div>
              <h2 class="text-[36px] font-semibold tracking-[-0.03em] leading-[1.1] text-[#171717] mb-4">Extract income data<br />from documents</h2>
              <p class="text-[17px] text-[#8E8E93] leading-[1.5] max-w-[440px] mx-auto mb-7">
                Upload pay stubs, W-2s, and tax returns already collected. Truv validates the documents and extracts structured income data for underwriting.
              </p>
            </div>
