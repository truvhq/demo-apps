...
export const STEPS = [
  ...
  { title: 'Borrower completes verification', guide: '<p>Sandbox credentials: <code>goodlogin</code> / <code>goodpassword</code></p><p><a href="https://docs.truv.com/developers/integration/bridge-widget/overview" target="_blank">Bridge Docs →</a></p>' },
  { title: 'Truv processes results', guide: '<p>Truv sends webhooks as the verification progresses.</p><p><a href="https://docs.truv.com/api-reference/webhooks" target="_blank">Webhooks Docs →</a></p>' },
  { title: 'Loan Processor reviews report', guide: '<p>Fetch reports:</p><pre>POST /v1/users/{user_id}/reports/</pre><p><a href="https://docs.truv.com/api-reference/user-income-and-employment-reports/users_reports" target="_blank">Reports API →</a></p>' },
];
