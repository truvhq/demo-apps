/**
 * FILE SUMMARY: Scaffolding for Mortgage: Document Processing demo.
 * INTEGRATION PATTERN: Document Collections API.
 *
 * Exports presentation-layer config consumed by DocumentProcessing.jsx: step
 * definitions, sample document metadata, intro slide config, feature cards,
 * and an UploadScreen component with drag-drop file picker. Contains no API
 * calls or state management beyond local UI state for drag-over highlighting.
 */
