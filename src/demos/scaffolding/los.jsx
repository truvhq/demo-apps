    ...
    <div class="intro-slide" style="justify-content: flex-start; padding-top: 3rem;">
      <div class="w-full max-w-lg mx-auto px-4 sm:px-8">
        <div class="animate-slideUp text-left mb-8">
          <h2 class="text-[28px] font-semibold tracking-[-0.02em] text-[#000000] mb-2">Add Test Borrower</h2>
        ...
        <form onSubmit={handleSubmit} class="animate-slideUp delay-1 text-left">
          ...
          <div class="mb-3">
            ...
            <p class="text-[13px] text-[#808080] mt-1">Truv sends the verification link to this email</p>
          </div>
          <div class="mb-3">
            ...
            <p class="text-[13px] text-[#808080] mt-1">Truv sends the verification link via SMS</p>
          </div>
          <div class="mb-5">
          ...
          <button type="submit" disabled={!firstName.trim() || !lastName.trim()} class="w-full py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-hover active:bg-primary-active transition-colors disabled:opacity-40">
            Continue
          </button>
        </form>
      </div>
