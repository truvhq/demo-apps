...
export const STEPS = [
  {
    ...
    guide: '<p>Enter an Application ID and create verification orders for each product type:</p>'
      ...
      + '<p><a href="https://docs.truv.com/api-reference/orders/orders_create" target="_blank">API Reference →</a></p>',
  },
  {
  ...
  },
  {
    ...
    guide: '<p>Truv sends webhooks as the verification progresses.</p>'
      + '<p><a href="https://docs.truv.com/api-reference/webhooks" target="_blank" rel="noopener noreferrer">Webhooks Docs →</a></p>',
  },
  {
    ...
    guide: '<p>Fetch reports based on product type:</p>'
      ...
      + '<p><a href="https://docs.truv.com/api-reference/user-income-and-employment-reports/users_reports" target="_blank" rel="noopener noreferrer">Reports API →</a></p>',
  },
];
