    ...
    <Layout badge="LOS" steps={STEPS} panel={panel} hidePanel={showIntro || showAddForm}>
      ...
      {showTable && (
        <div class="max-w-4xl mx-auto px-4 py-6 sm:px-8 sm:py-10">
          <h2 class="text-[28px] font-semibold tracking-[-0.02em] text-[#000000] mb-2">Borrowers</h2>
          <p class="text-[15px] text-[#808080] leading-[1.5] mb-5">Completed borrowers shown for reference. Your test borrower will receive a verification link.</p>
          ...
          {order?.share_url && (
            <div class="border border-[#d2d2d7] rounded-xl p-4 mb-6 bg-[#f5f5f7]">
              <div class="text-[13px] font-semibold text-[#808080] uppercase tracking-wide mb-2">Share URL (sent to borrower)</div>
