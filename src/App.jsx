...
export const INDUSTRIES = [
  ...
  },
  {
    ...
    demos: [
      ...
      { id: 'bank-coverage', name: 'Bank Coverage', component: BankCoverageDemo, desc: 'Upload a CSV of up to 10,000 banks and see which ones Truv can connect to via Bridge for income insights, PLL, or deposit-switch.', tags: ['Bulk', 'providers', 'financial_accounts', 'CSV'] },
    ],
  },
];
