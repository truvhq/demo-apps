...
// Shared button styling for the outline (secondary) actions.
const OUTLINE_BTN = 'text-[13px] font-medium text-[#171717] bg-white border border-[#e8e8ed] rounded-md px-3 py-1.5 hover:bg-[#f5f5f7] hover:border-[#d1d1d6] transition-colors inline-flex items-center gap-1.5';

// External-link arrow appended to outbound links.
...
export function HeaderActions() {
  return (
    <div class="flex items-center gap-2">
      <a href={GITHUB_URL} target="_blank" rel="noreferrer" class={OUTLINE_BTN}>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        class="text-[13px] font-medium text-white bg-primary rounded-md px-3 py-1.5 hover:bg-primary/90 transition-colors whitespace-nowrap"
      >
        Contact sales
      </a>
    </div>
