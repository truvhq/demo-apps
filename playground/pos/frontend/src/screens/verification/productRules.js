...
// live sandbox account by POSTing every combination and recording the actual
// accept/reject behavior (2026-08-07). Mirrors truv_integration/product_rules.py,
// which is the server-side backstop for the same rules — this module is what
// keeps the Configure Truv console from ever letting a user build one of
...
/** Bridge Token takes exactly one product. */
export function isSingleSelectMethod(method) {
  return method === 'bridge_token';
}
