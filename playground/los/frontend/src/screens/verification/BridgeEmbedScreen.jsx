...
/** Embeds Truv's Bridge widget inline — LOS's copy of POS's component (same
 * cdn.truv.com/bridge.js script tag must be loaded in index.html).
 *
 * Two things confirmed against the reference implementation:
